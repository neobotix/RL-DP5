...
namespace cpr_robot
{
        ...
        Robot(4,1)
    {
        ...
        define_Output(true,0,0,"Digital out 5");
        define_Output(true,0,1,"Digital out 6");
        define_Output(true,0,1,"Digital out 7");
    ...
    //! Destructs an instance of the igus_4DOF_SV class  
    igus_4DOF_SV::~igus_4DOF_SV()
    {
